...
class Aula23{
    static void Main(){
        ...
        //public static void Copy(Ar_destino,qtde_elementos);
        ...
        long qtedElementosVetor=vetor1.GetLongLength(0);
        Console.WriteLine("Quantidade de elementos {0}",qtedElementosVetor);
        Console.WriteLine("--------------------------------------------");

        //public int GetLowerBound(dimensão);
        Console.WriteLine("GetLowerBound");
        int MenorIndiceVetor=vetor1.GetLowerBound(0);
        int MenorIndiceNatriz_D1=matriz.GetLowerBound(1);
